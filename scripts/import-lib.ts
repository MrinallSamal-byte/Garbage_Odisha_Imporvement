...
import politicalMappingJson from "@/data/civic/bhubaneswar-political-area-mapping.seed.json";
...
export async function seedPoliticalAreaMapping() {
  ...
  if (env.APP_MODE === "mock") {
    console.log(`Validated ${city}, ${state} political mapping seed version ${version}. Switch APP_MODE=real to load PostgreSQL.`);
    return;
  }
